...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<RequestResponse<String>> TweetAppException(CustomException exception) {

		RequestResponse<String> env = new RequestResponse<>(exception.getStatusCode(), exception.getStatus(), exception.getData());
		log.debug("CustomException StatusCode{} Message{}", exception.getStatus(), exception.getData());
